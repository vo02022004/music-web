...
export default function SignInSide() {
  const handleLogin = async (user: LoginInput) => {
    // Thực hiện đăng nhập và lưu token vào cookie nếu đăng nhập thành công
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    // Ngăn chặn hành vi mặc định của form và gọi hàm đăng nhập
    ...
    // Lấy thông tin người dùng từ form và gọi hàm đăng nhập
